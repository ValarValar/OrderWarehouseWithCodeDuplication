...
def order_create_update_signal(sender, instance: Order, created, **kwargs):
    ...
    post_url = 'http://127.0.0.1:8000/order_webhooks/order/'
    patch_url = f'http://127.0.0.1:8000/order_webhooks/order/{instance.order_name}/'
    if created:
...
def order_delete_signal(sender, instance: Order, **kwargs):
    delete_url = f'http://127.0.0.1:8000/order_webhooks/order/{instance.order_name}/'
